...
const mockProvider = Layer.succeed(Provider.Service, {
...
function prunedMsg(sessionID: SessionID, role: "user" | "assistant", text: string): SessionV1.WithParts {
...
const fakeUser = { id: MessageID.ascending(), role: "user" } as unknown as SessionV1.User
