...
export const BtwResult = Schema.Struct({ text: Schema.String })
    ...
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.post("btw", SessionPaths.btw, {
          ...
          query: WorkspaceRoutingQuery,
          payload: BtwPayload,
          success: described(BtwResult, "Side-question answer"),
          error: [HttpApiError.BadRequest, ApiNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
            ...
            description:
              "Answer a quick side question using the session context, tool-lessly and without persisting anything to the session.",
          }),
        ),
