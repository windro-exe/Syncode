        ...
        <DialogBody class="flex flex-col gap-5 overflow-y-auto p-5">
          ...
          <div class="flex flex-col gap-2.5">
            <div class="flex items-center justify-between">
              ...
              <span class="text-11-regular text-text-weak">{rulesStore.rules.length} rules</span>
            </div>

            <Show
              when={rulesStore.rules.length > 0}
              fallback={
                  ...
                  {(rule, index) => (
                    <div class="flex items-center gap-2 p-2 rounded bg-surface-base border border-border-base hover:border-border-hover group">
                      ...
                      <input
                        ...
                        value={rule}
                        onBlur={(e) => editRule(index(), e.currentTarget.value)}
                        onKeyDown={(e) => {
                          if (e.key === "Enter") {
