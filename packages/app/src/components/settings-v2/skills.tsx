    ...
    <div class="settings-v2-tab">
      <div class="settings-v2-tab-header">
        <div class="flex flex-col gap-1">
          <h2 class="settings-v2-tab-title">Skills & Progressive Discovery</h2>
          <p class="text-12-regular text-text-weak">
            Configure Antigravity progressive skill routing, dynamic TOC injection, and skill catalog locations.
          </p>
        </div>
      </div>
      ...
      <div class="settings-v2-tab-body">
        ...
        <div class="settings-v2-section">
          <div class="settings-v2-section-title">Antigravity Skill Router</div>
          <SettingsListV2>
            <SettingsRowV2
        ...
        {/* Discovery Locations */}
        <div class="settings-v2-section">
          <div class="settings-v2-section-title">Skill Discovery Locations</div>
